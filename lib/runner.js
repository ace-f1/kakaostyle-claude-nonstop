...
const FAILBACK_POLL_MS = Number.parseInt(process.env.CLAUDE_NONSTOP_FAILBACK_POLL_MS || '', 10) || 60_000;
/** Idle window before failback may interrupt the active Claude process. */
const FAILBACK_IDLE_MS = Number.parseInt(process.env.CLAUDE_NONSTOP_FAILBACK_IDLE_MS || '', 10) || 5_000;
/** Cooldown after any account switch before failback is allowed. */
const FAILBACK_COOLDOWN_MS = Number.parseInt(process.env.CLAUDE_NONSTOP_FAILBACK_COOLDOWN_MS || '', 10) || 10 * 60_000;
